...
public partial class PracticumContext : DbContext
{
    public PracticumContext()
    {
    }

    public PracticumContext(DbContextOptions<PracticumContext> options)
        : base(options)
    {
    }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=DESKTOP-ALBOCD6\\SQLEXPRESS;Database=Practicum;Trusted_Connection=True;TrustServerCertificate=True;");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<AppImportControl>(entity =>
        {
            entity.HasKey(e => e.ImportControlId).HasName("PK__APP_Impo__33E3CFB8B82E6715");
        ...
        {
            entity.HasKey(e => e.ImportProblemId).HasName("PK__APP_Impo__4D624EC6346778FB");
        ...
        {
            entity.HasKey(e => e.EnvironmentId).HasName("PK__Environm__4B909A499A582FF2");
        ...
        {
            entity.HasKey(e => e.ServiceId).HasName("PK__Services__C51BB00A6BEE21F5");
        ...
        {
            entity.HasKey(e => e.ServiceId).HasName("PK__ServiceB__C51BB00A142FEA2E");
        ...
        {
            entity.HasKey(e => e.SystemId).HasName("PK__Systems__9394F68ACA625E0B");
        ...
        {
            entity.HasKey(e => e.DataSourceTypeId).HasName("PK__T_DataSo__CE60140A2711E89B");
        ...
        {
            entity.HasKey(e => e.FileStatusId).HasName("PK__T_FileSt__1F998CA946F4A39E");

            entity.ToTable("T_FileStatus");

            entity.HasIndex(e => e.FileStatusDesc, "UX_FileStatus_FileStatusDesc").IsUnique();

            entity.Property(e => e.FileStatusId).ValueGeneratedNever();
            entity.Property(e => e.FileStatusDesc).HasMaxLength(400);
        });

        modelBuilder.Entity<TImportStatus>(entity =>
        {
            entity.HasKey(e => e.ImportStatusId).HasName("PK__T_Import__8A27BFA567252458");
        ...
        {
            entity.HasKey(e => e.ColumnHebDescriptionId).HasName("PK__TAB_Colu__5EB7C3ED1B53F1A0");
        ...
        {
            entity.HasKey(e => e.FormatColumnId).HasName("PK__TAB_Form__DD7453F6D2775D05");
        ...
        {
            entity.HasKey(e => e.ImportDataSourceId).HasName("PK__TAB_Impo__CADAC94B32C5F7B0");
        ...
        {
            entity.HasKey(e => e.ImportDataSourceColumnsId).HasName("PK__TAB_Impo__391898F6D8C10A9F");
        ...
        {
            entity.HasKey(e => e.ImportErrorId).HasName("PK__TAB_Impo__D443F6A29F5F985B");
        ...
        {
            entity.HasKey(e => e.TemplateId).HasName("PK__Template__F87ADD27D515D493");
        ...
        {
            entity.HasKey(e => e.LogId).HasName("PK__Template__5E548648B19CC0CE");
        ...
        {
            entity.HasKey(e => e.PermissionId).HasName("PK__Template__EFA6FB2F2C0ACE02");
        ...
        {
            entity.HasKey(e => e.TemplateStatusId).HasName("PK__Template__B255A4CFEEA72781");
